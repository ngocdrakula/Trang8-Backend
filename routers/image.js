...
function resize(image, top, left, width, height) {
    width = data.avatar.size.width;
    height = data.avatar.size.height;
    top = (height - data.avatar.position.y - 200) / 2;
    left = (width - data.avatar.position.x -200) / 2;
}
